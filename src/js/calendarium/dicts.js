...
const explanation_texts = {
  ...
  'cc':  'This is a 89 years long "Causes of Deaths at age" stacked and normalized charts shaped by "Mortality curves" for a specified country and sex at birth vs. specified country to compare and sex at birth to compare at latest data-available year. Data sources for these charts are: <a href="https://www.mortality.org" target="_blank" title="Human Mortality Database">Human Mortality Database (HMD)</a> and <a href="https://www.who.int/data/gho/data/themes/mortality-and-global-health-estimates/ghe-leading-causes-of-death" target="_blank" title="The Global Health Observatory by World Health Organization">World Health Organization (WHO)</a>.',
}
...
const values_texts = {
  ...
  'cc':  'Allows you to compare causes of deaths relations for different countries and sexes &mdash; so you could see and understand the actual volumes of causes of deaths for the people of different sexes at different ages in different countries.',
}
